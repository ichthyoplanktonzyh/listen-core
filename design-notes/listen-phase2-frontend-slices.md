...
| --- | --- | --- |
| A 基建 | S0=#77 | 前置决策已定 |
| B 纯前端 | S1=#78 · S2=#81 · S3=#79 · S4=#82 · S5=#80 | 无(S2←S3, S4←S3) |
| C 对话 | S6=#83 · S7=#84 · S8=#85 · S9=#86 · S10=#87 | 无(S7/S8/S9←S6) |
| D 复习 anki | S11 S12 S13 S14(未开,阻塞后端) | #72/#73/#74 |

共 **15 刀**。波次 A+B+C(11 刀,issue #77-#87 已开)现在就能推进;
波次 D(4 刀)等后端交付时再开 issue。

**串行执行(owner 定,一刀一会话)**:S0(#77)是起点;做完 S0 解锁 B/C 波。
B 波内 S1/S3/S5 无强依赖,S2←S3、S4←S3;C 波 S7/S8/S9←S6。
