DROP TABLE IF EXISTS lexical_observations;
DROP TABLE IF EXISTS lexical_status_history;
DROP TABLE IF EXISTS lexical_occurrences;
DROP TABLE IF EXISTS lexical_entries;
DROP TABLE IF EXISTS lemma_overrides;
