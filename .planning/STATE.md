...
Active maintenance slice: establish independent repository governance and reset
live planning from current backend code facts.
...
2. Audit remaining core scripts/docs that still assume the old monorepo.
3. Use `.planning/CROSS_REPO.md` for the next app-driven contract request.
